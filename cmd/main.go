...
func main() {
	...
	http.HandleFunc("/statement", httpLog)
	fmt.Println(time.Now().UTC().Format("2006-01-02 15:04:05.999"), "-", "Monobank processor started on", httpPort)
...
func httpLog(writer http.ResponseWriter, request *http.Request) {
